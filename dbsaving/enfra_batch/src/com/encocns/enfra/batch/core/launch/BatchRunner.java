...
public class BatchRunner {
	//Batch Job의 시작, 정지, 재시작에 사용되는 JobOperator1
	 ...
	 * @param jobRepository
	 */
	public BatchRunner(JobOperator jobOperator, JobExplorer jobExplorer, JobRepository jobRepository) {
	...
	public Long start(String jobName, String jobParameters) throws NoSuchJobException, JobParametersInvalidException, JobInstanceAlreadyExistsException  {
		return jobOperator.start(jobName, "jobName=" + jobName + ", " + jobParameters);
	}
