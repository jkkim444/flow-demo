 ...
 * @version : 1.0.0
 */
public class IP206001OUT {
    private int totalCount;				/* 총 건수 */
    private int currentPageNo;			/* 페이지 번호 */
    private List<IP206001DTO> list;		/* 조회 내용 */
	...
	public List<IP206001DTO> getList() {
		return list;
	}
	public void setList(List<IP206001DTO> list) {
		this.list = list;
	}
