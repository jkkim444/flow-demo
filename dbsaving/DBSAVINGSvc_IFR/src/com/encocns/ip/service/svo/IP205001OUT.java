...
/**
 * @brief 기타충당금 기본 management OUT
 * @details 기타충당금 기본 management OUT
 * @author : 이동겸
 * @date : 2020. 09. 01.
 * @version : 1.0.0
 */
public class IP205001OUT {
    private int totalCount;				/* 총 건수 */
    private int currentPageNo;			/* 페이지번호 */
    private List<IP205001DTO> list;		/* 조회 내용 */
	...
	public List<IP205001DTO> getList() {
		return list;
	}
	public void setList(List<IP205001DTO> list) {
		this.list = list;
	}
