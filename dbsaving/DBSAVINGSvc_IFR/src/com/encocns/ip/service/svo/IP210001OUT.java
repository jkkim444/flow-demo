...
/**
 * @brief 담보가액관리 management OUT
 * @details 담보가액관리 management OUT
 * @author : 이동겸
 * @date : 2020. 09. 01.
 * @version : 1.0.0
 */
public class IP210001OUT {
    private int totalCount;				/* 총 건수 */
    private int currentPageNo;			/* 페이지번호 */
    private List<IP210001DTO> list;		/* 조회 내용 */
	...
	public List<IP210001DTO> getList() {
		return list;
	}
	public void setList(List<IP210001DTO> list) {
		this.list = list;
	}
