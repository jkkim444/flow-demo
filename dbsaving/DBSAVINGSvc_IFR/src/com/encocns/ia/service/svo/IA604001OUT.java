 ...
 * @version : 1.0.0
 */
public class IA604001OUT {
    private List<IA604001DTO> arrList;		/* 조회 내용 */
    private String pbnfCtnt;				/* 마감여부내용 */

    public List<IA604001DTO> getArrList() {
        return arrList;
    }
    public void setArrList(List<IA604001DTO> arrList) {
