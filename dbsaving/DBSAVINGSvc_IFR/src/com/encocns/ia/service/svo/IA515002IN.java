...
public class IA515002IN {
	...
	private BigDecimal lndAcqsAmt;              /* 임차시설물취득금액 */
	private BigDecimal lndDprcCmtlAmt;          /* 상각누계금액 */
	private BigDecimal bldgAcqsAmt;             /* 임차시설물취득금액 */
	private BigDecimal bldgDprcCmtlAmt;         /* 건물상각누계금액 */
	private String acqsDt;                      /* 취득일자 */
	private String jobDivCd;                    /* 작업구분코드 */
