 ...
 * @date : 2020. 09. 10.
 */
public class ID104001OUT {

	private List<ID104001DTO> arrList;               /* 보고서 내용 */
	private List<ID104002DTO> arrListMerge;          /* 병합 내용 */
	private String pbnfRptNm;                        /* 공시보고서명 */
	private String pbnfCtnt;                      	 /* 마감여부내용 */

	public List<ID104001DTO> getArrList() {
		return arrList;
	}
	public void setArrList(List<ID104001DTO> arrList) {
		this.arrList = arrList;
	}
	public List<ID104002DTO> getArrListMerge() {
		return arrListMerge;
	}
	public void setArrListMerge(List<ID104002DTO> arrListMerge) {
