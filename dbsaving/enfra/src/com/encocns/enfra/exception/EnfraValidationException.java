...
public class EnfraValidationException extends RuntimeException {
	...
	public EnfraValidationException(){}

	public EnfraValidationException( String err_cd )
	{
		this.err_cd = err_cd;
	...
	public EnfraValidationException( String err_cd, String param )
	{
		this.err_cd = err_cd;
		this.param = param;
	...
	public EnfraValidationException( String err_cd, String[] params )
	{
		this.err_cd = err_cd;
		this.params = params;
